...
def select_slide(slide_name):
    ...
    basic_slides = {
        ...
        'Pre_Instructions': [
            ...
            u"Según nuestra base de datos, uno de estos participantes {DISPLAY_NAME_INGROUP} en la próxima elección presidencial",
            u"Mientras que el otro {DISPLAY_NAME_OUTGROUP}.",
            u"Estas personas participan de otros experimentos y sus respuestas no afectan tu participación en este estudio.",
            " ",
            ...
            u"Los otros participantes no saben que túe estás realizando este experimento",
        ...
        'Cargando':[
            ...
            u"Estos participantes están realizando otros experimentos y por tanto realizan tareas distinta a la tuya",
            " ",
        ...
        'Instructions_Decision_1': [
            ...
            " ",
            u"En esta tarea, tú tendrás que rellenar la barra para ganar créditos utilizando la barra espaciadora.",
            u"Los créditos que acumules serán convertidos en gift cards al final de la tarea",
            " ",
            u"Estos créditos pueden ser otorgados a {DISPLAY_NAME_SELF}, para la persona que {DISPLAY_NAME_INGROUP}, o que {DISPLAY_NAME_OUTGROUP}",
            ...
            u"En otras rondas , decidirás si quieres ganar créditos para la persona que {DISPLAY_NAME_INGROUP}, o que {DISPLAY_NAME_OUTGROUP}",
            u"Los créditos que ganes serán convertidos en giftcards para ti y para los otros participantes.",
            u"Recuerda que tus decisiones serán anónimas y confidenciales, y los otros participantes no sabrán lo que tú elijas",
        ...
        'Effort_ending': [
            ...
            u"Aquí tendrás que tomar decisiones entre descansar o llenar la barra presionando la tecla espaciadora"
