...
max_answer_time = 5 # Tiempo máximo para responder en segundos
...
def select_slide(slide_name):
    ...
    basic_slides = {
        ...
        'Instructions_Decision_3': [
            ...
            u"debes rellenar la barra, presionando Espacio repetidamente durante en 10 segundos.",
            u"De lo contrario, no se otorgarán créditos para esa ronda.",
            " ",
            u"Siempre que elijas la opción Descansar, podrás reposar durante 10 segundos."
        ],
        ...
        'Practice_ending': [
            ...
            u"Si eliges Trabajar, tendrás que rellenar la barra que se muestra en pantalla en 10 segundos.",
            u"Si eliges Descansar, podrás hacerlo durante 10 segundos."
        ],
        'TestingDecision': [
